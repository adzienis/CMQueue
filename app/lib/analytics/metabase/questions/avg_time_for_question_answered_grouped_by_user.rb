class Analytics::Metabase::Questions::AvgTimeForQuestionAnsweredGroupedByUser
  def initialize(database_id:, course_schema:, collection_id:)
  ...
  def call
    raise NotImplementedError unless filters.present?
        ...
        "native":{
          "template-tags":{
            "full_name":{
              ...
              "type":"dimension",
              "required":false,
              "dimension":["field", filters[:full_name],nil],
            ...
            "date":{
              ...
              "display-name":"Date",
              "type":"dimension",
              "dimension":["field", filters[:date],nil],
  ...
  attr_accessor :database_id, :course_schema, :filters, :collection_id
