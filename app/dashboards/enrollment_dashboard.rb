...
class EnrollmentDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    course: Field::HasOne,
    question_state: Field::HasOne,
    question_states: Field::HasMany,
    questions: Field::HasMany,
    id: Field::Number,
    semester: Field::Select.with_options(searchable: false, collection: ->(field) { field.resource.class.send(field.attribute.to_s.pluralize).keys }),
