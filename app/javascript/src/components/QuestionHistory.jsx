...
export default (props) => {
  ...
  const {data: previous_questions } = useQuery(['questions', question?.id, 'previousQuestions'])

  return (
    <>
      <button type="button" onClick={e => { e.preventDefault(); e.stopPropagation()}} className="btn btn-secondary position-relative" data-bs-toggle="modal" data-bs-target={`#question_${question?.id}`}>
        <span>
