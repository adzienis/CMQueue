            ...
            <>
                <div className="position-relative">
                    ...
                    <div className='card shadow-sm' style={{height: '620px'}}>
                        <div className='card-body' style={{opacity: .3, pointerEvents: 'none'}}>
                            <h1>
                                Ask a Question
                            </h1>
                            <form>
                                ...
                                <div className="mb-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                    />
                                    {formErrors.tried && <span className="invalid-feedback d-block">
                                ...
                                <div className="mb-3">
                                    ...
                                    />
                                    {formErrors.location && <span className="invalid-feedback d-block">
